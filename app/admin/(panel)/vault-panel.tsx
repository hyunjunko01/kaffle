      ...
      <form onSubmit={(event) => void fund(event)} className="space-y-3">
        <label className="block text-sm text-muted">
          ...
          <input
            ...
            className="mt-1 h-11 w-full rounded-[var(--kaffle-radius-sm)] border border-border bg-transparent px-4 text-sm text-foreground outline-none focus:border-border-strong"
          />
        </label>
        <div className="flex gap-2">
          <button
            ...
            className="inline-flex h-11 flex-1 items-center justify-center rounded-[var(--kaffle-radius-sm)] bg-accent px-5 text-base font-semibold text-ink-inverse transition hover:opacity-90 disabled:opacity-60"
          >
          ...
          <button
            ...
            className="inline-flex h-11 items-center justify-center rounded-[var(--kaffle-radius-sm)] border border-border px-4 text-sm font-medium transition hover:bg-surface disabled:opacity-60"
          >
            새로고침
          </button>
        </div>
