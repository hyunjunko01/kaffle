  ...
  return (
    <main className="mx-auto flex w-full max-w-lg flex-1 flex-col justify-center px-6 py-16">
      ...
      <form action={enterFromLanding} className="mt-10 flex justify-center">
        <button
          type="submit"
          className="inline-flex h-12 items-center justify-center rounded-xl border border-zinc-200 bg-white px-8 text-base font-medium transition hover:bg-zinc-50 active:translate-y-px dark:border-zinc-800 dark:bg-transparent dark:hover:bg-zinc-900"
        >
          Join Kaffle
        </button>
      </form>
