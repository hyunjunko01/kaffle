      ...
      <div className="w-full max-w-sm text-center">
        ...
        {status === "checking" ? (
          ...
          <a
            ...
            className="mt-8 inline-flex h-12 w-full items-center justify-center gap-2 rounded-[var(--kaffle-radius-sm)] bg-[#FEE500] text-sm font-semibold text-[#191919] transition hover:bg-[#f5dc00]"
          >
            <KakaoMark />
            카카오 로그인
          </a>
