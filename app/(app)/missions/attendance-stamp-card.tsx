  ...
  return (
    <section className="mt-8 flex flex-col items-center">
      ...
      <button
        ...
        className={`mt-4 flex aspect-square w-40 items-center justify-center rounded-sm border-2 border-dashed transition disabled:cursor-default ${
          stamped
      ...
      >
        {stamped ? (
          <span
            className="rotate-[-12deg] rounded-sm border-2 border-accent px-3 py-2 font-display text-lg font-bold tracking-wide text-accent-ink"
            aria-hidden="true"
          >
            출석 완료
          </span>
